// modmap.js — zentraler Modul-/Export-Katalog für Preflight & App-Ops
...
export const PF_MODULES = [
  ...
  // Tools/Extras (optional; Genealogy ist komplett entfernt)
  { path: "./editor.js",       wants: ["openEditor"], optional: true },
  { path: "./environment.js",  wants: ["openEnvPanel"], optional: true },
  { path: "./dummy.js",        wants: ["openDummyPanel"], optional: true },
  { path: "./appops_panel.js", wants: ["openAppOps"], optional: true },
  { path: "./appops.js",       wants: ["generateOps","getMdcCodes","runModuleMatrix","startCollectors","getAppOpsSnapshot"], optional: true },
